...
<div class="w-full max-w-md bg-gray-800 rounded-lg p-8">
    ...
    <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="number" class="w-full px-3 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="harga" name="harga" step="0.01">
        </div>
        <div class="mb-6">
